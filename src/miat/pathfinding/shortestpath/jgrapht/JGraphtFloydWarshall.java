...
public class JGraphtFloydWarshall implements ShortestPathAlgorithm {
	...
	public Result shortestPathComputation(Graph<Integer, DefaultEdge> graph, String source, String target) {
		FloydWarshallShortestPaths<Integer, DefaultEdge> bf = new FloydWarshallShortestPaths<>(graph);
	...
	public Result spatialShortestPathComputation(Graph<Coordinate, DefaultEdge> graph, Coordinate source,
			Coordinate target) {
		FloydWarshallShortestPaths<Coordinate, DefaultEdge> bf = new FloydWarshallShortestPaths<>(graph);
		long t = System.currentTimeMillis();
